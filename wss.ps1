...
reg add HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced /t REG_DWORD /v TaskbarAI /d 0 /f
...
Start-Process -FilePath "C:\Windows\Resources\Themes\dark.theme" -NoNewWindow
